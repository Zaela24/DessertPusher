...
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    @OnLifecycleEvent(Lifecycle.Event.ON_START) // starts timer when activity on screen
    fun startTimer() {
    ...
    @OnLifecycleEvent(Lifecycle.Event.ON_STOP) // stops timer when activity offscreen
    fun stopTimer() {

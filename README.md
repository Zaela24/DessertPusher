...
## Extra Info
This app was pre-built for this less. It was, however, incredibly useful to help me gain a better understanding of lifecycles in android, and how to temporarily save extra data about what state the app is in if the process gets killed by the AndroidOS.
